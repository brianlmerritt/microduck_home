<!-- Parent-project reference wrapper; the source body below is unchanged. -->

> **English source copy, not a translation.** Original: [`microduck_rl/docs/superpowers/specs/2026-07-27-swizzle-head-control-design.md`](../../../../microduck_rl/docs/superpowers/specs/2026-07-27-swizzle-head-control-design.md).
> Source commit: `2b581c641406a48346e696212930ea881c222c52`. Copied and checked against source on 2026-09-17.
> The original document's authorial voice, commands, identifiers and checkboxes are preserved below. They describe historical design/implementation work; they are reference material, not instructions to execute during the current experiment.

**Current-source note (separate from the original):** The head command, actor/critic observation wiring, head tracking reward, removal of HOME-pulling neck rewards, and late curricula are implemented in the pinned Swizzle configuration. The active reward schedule reaches 2.0 at iteration 2250 and 4.0 at 3000. Runtime button/flag statements belong to the historical runtime described by the author and were not independently validated here.

See the [environment guide](../../environment_guide.md) and [document index](../../README.md) for the current walking/recovery project.
