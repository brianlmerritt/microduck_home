...
> **English source copy, not a translation.** Original: [`microduck_rl/docs/superpowers/specs/2026-07-23-swizzle-env-design.md`](../../../../microduck_rl/docs/superpowers/specs/2026-07-23-swizzle-env-design.md).
...
**Current-source note (separate from the original):** The registered task and defining swizzle rewards exist. This early design describes straight-line push/coast/brake behaviour; the current Swizzle configuration also supports backward motion and a heading curriculum, and removes the braking reward. Read the current configuration for current command semantics.
