...
> **English source copy, not a translation.** Original: [`microduck_rl/docs/superpowers/plans/2026-07-27-swizzle-head-control.md`](../../../../microduck_rl/docs/superpowers/plans/2026-07-27-swizzle-head-control.md).
...
**Current-source note (separate from the original):** The proposed head-control configuration is present in the pinned Swizzle source, with an additional filter removing neck/head/passive entries from pose reward standard-deviation dictionaries. Unchecked checkboxes below are preserved historical text; they do not mean the feature is unimplemented. Runtime button/flag statements were not independently validated here.
